                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                               <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="viewpharmacy.jsp" class="fa-comment">View Pharmacists</a>
                                       
                                    </li>
                                    <li>
                                        <a href="viewdoctor.jsp" class="fa-comment  active">View Doctors</a>
                                    </li>                                    
                ...
                %>
                    ...
                    <table width="60%" border="2">
                      ...
                      <br><br><table align="center" border="2">
                       <tr ><th><a href="docreg.jsp" >Add Doctor</a></th></tr>    
                       </table>
                    </center><br><br>
                    </div>
                    </div>

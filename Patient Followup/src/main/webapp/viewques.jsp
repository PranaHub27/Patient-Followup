				...
				<center>
					...
					<%
						...
						PreparedStatement pst = con.prepareStatement(
								"SELECT distinct patient.mobile, cal1.pid, cal1.doid,cal1.status FROM cal1,patient WHERE cal1.status='waiting' and patient.patid=cal1.pid and cal1.schedule=curdate()");
					...
					<table width="60%" border="2">
						...
						<tr style="color: black">
							...
							<th><a
								href="c.jsp?a=<%=rs.getString("pid")%>&b=<%=rs.getString("doid")%>&d=<%=rs.getString("mobile")%>">Call</a></th>
							<th><a
								href="reschedule.jsp?a=<%=rs.getString("pid")%>&b=<%=rs.getString("doid")%>">re-Schedule</a></th>

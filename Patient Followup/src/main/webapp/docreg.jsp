					...
					<div class="col-md-8 no-padding">
						<div class="visible-lg">
							<ul id="hornavmenu" class="nav navbar-nav">
								...
								<li><a href="viewpharmacy.jsp" class="fa-comment">View
										Pharmacists</a></li>
								<li><a href="viewdoctor.jsp" class="fa-comment active">View
										Doctor</a></li>
		...
		<div id="content" class="bottom-border-shadow">
			<div class="container background-white bottom-border">
				<center>
					<br>
					<h1>
						<font color="black">Doctor Registration</font>
					</h1>
					...
					<form name="myform" action="docregact.jsp" method="post">
						<table border="0">
							...
							<tr>
								<td><font color="black"> Doctor Name :</td>

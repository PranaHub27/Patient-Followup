					...
					<div class="col-md-8 no-padding">
						<div class="visible-lg">
							<ul id="hornavmenu" class="nav navbar-nav">
								...
								<li><a href="pharmacist.jsp" class="fa-user ">Pharmacist</a>

								</li>
								<li><a href="doctor.jsp" class="fa-user ">Doctor</a></li>

								<li><a href="patient.jsp" class="fa-user active">Patient</a>
								</li>

								<li><a href="admin.jsp" class="fa-user ">Admin</a></li>

								<li><a href="contactus.jsp" class="fa-comment ">Contact
										US</a></li>
							</ul>
						</div>
					</div>
		...
		<div id="content" class="bottom-border-shadow">
			<div class="container background-white bottom-border">
				<center>
					<br>
					<h1>
						<font color="black">Patient Login</font>
					</h1>

			...
			<div class="container background-white bottom-border">
				<center>
					...
					<%
						...
						PreparedStatement pst = con.prepareStatement("select distinct pid from cal1 where status='done'");
						...
						<form name="frm" action="image_project_dviewp1.jsp" method="post">
							<table>
								<tr>
									...
									<td><select name="pid" id="product" onChange="getcomp()">

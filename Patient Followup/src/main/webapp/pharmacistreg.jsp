					...
					<div class="col-md-8 no-padding">
						<div class="visible-lg">
							<ul id="hornavmenu" class="nav navbar-nav">
								<li><a href="adminhome.jsp" class="fa-home  ">Home</a></li>
								<li><a href="viewpharmacy.jsp" class="fa-comment active">View
										Pharmacists</a></li>
								<li><a href="viewdoctor.jsp" class="fa-comment ">View
										Doctor</a></li>

								<li><a href="viewpatient.jsp" class="fa-gears ">View
										Patient</a></li>
		...
		<div id="content" class="bottom-border-shadow">
			<div class="container background-white bottom-border">
				<center>
					<br>
					<h1>
						<font color="black">pharmacist Registration</font>
					</h1>
					...
					<form name="myform" action="pharmacistregact.jsp" method="post">
						<table border="0">
							...
							<tr>
								<td><font color="black"> pharmacist Id :</td>
								<td><input type="text" name="id" required="" /></td>
							</tr>
							<tr>
								<td><font color="black"> pharmacist Name :</td>
							...
							<tr>
								<td><font color="black">Mobile :</td>
								<td><input type="text" name="mobile" required="" /></td>
							</tr>

							<tr rowspan="2" align="center">
								<td><br> <input type="submit" name="submit"
									value="    Add Pharmacist   " /></td>
								<td><br> <input type="reset" name="submit"
									value="    Cancel    " /></td>
							</tr>
							<tr></tr>
						</table>

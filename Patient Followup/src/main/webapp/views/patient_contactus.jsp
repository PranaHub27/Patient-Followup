    ...
    <body>
        <div id="body-bg">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="qq.jsp" class="fa-comment ">Questionnaire</a>
                                    ...
                                    <li>
                                        <a href="patient_contactus.jsp" class="fa-comment ">Contact US</a>
                                    </li>
            ...
            <div id="slideshow" class="bottom-border-shadow">
             ...
             <table align="center"><th><form action="patient_contactusact.jsp" method="get">

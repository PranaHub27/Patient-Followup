...
<html lang="en">
    ...
    <body>
        <div id="body-bg">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="image_project_display.jsp" class="fa-comment">View Patient Questionnaire</a>
                                       
                                    </li>
                                    
                                     <li>
                                        <a href="viewqueries.jsp" class="fa-comment  active  ">Patient Enquiry</a>
                                    </li>
                                    <li>
          ...
          <center>
          <br>
                    <h1><font color="black">View Queries</font></h1>                    
                    <br>
                    
                <%
                
                Connection con = Dbconnection.getConnection();
                PreparedStatement pst=con.prepareStatement("select * from contactus");
